...
public class BillingDetails {
    ...
    //CREATING A POJO CLASS (PlainOldJavaObject)
    ...
    public BillingDetails(String billingFirstName, String billingLastName,
                          ...
                          String billingEmail) {
        this.billingFirstName = billingFirstName; //setting the instance variables to the value of the argument
    ...
    //create getters and setters from these variables
